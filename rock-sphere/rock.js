function init() {
  ...
  sphereMaterial.map = loader.load(
    "/rock-sphere/assets/textures/giants-causeway/giants_causeway_basecolor.jpg"
  );
  sphereMaterial.bumpMap = loader.load(
    "/rock-sphere/assets/textures/giants-causeway/giants_causeway_normal.jpg"
  );
  sphereMaterial.normalMap = sphereMaterial.bumpMap;
  sphereMaterial.roughnessMap = loader.load(
    "/rock-sphere/assets/textures/giants-causeway/giants_causeway_roughness.jpg"
  );
  sphereMaterial.displacementMap = loader.load(
    "/rock-sphere/assets/textures/giants-causeway/giants_causeway_height.jpg"
  );
  sphereMaterial.metalnessMap = loader.load(
    "/rock-sphere/assets/textures/giants-causeway/giants_causeway_metallic.jpg"
  );
  sphereMaterial.aoMap = loader.load(
    "/rock-sphere/assets/textures/giants-causeway/giants_causeway_ambientocclusion.jpg"
  );
  // Three.js default : 1
...
function loadCubemap(number) {
  var path = "/rock-sphere/assets/cubemap/cmap-" + number + "/";
  var format = ".png";
  var urls = [
    path + "px" + format,
    path + "nx" + format,
